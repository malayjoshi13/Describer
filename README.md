...
## 2) Captions generated by Describe
...
### 3.1) Prediction using Web-application

**3.1.1)** Install Miniconda in your system from link:- https://docs.conda.io/en/latest/miniconda.html. Also install Git Bash from link:- https://git-scm.com/downloads.

**3.1.2)** Open Git Bash and type following code in it to clone this GitHub repository at any location of your wish. In my case I took ```C:\Users\thispc\Desktop```, you can change it with location path of your own:-
```
...
**3.1.3)** Now type following code in your command prompt (CMD):- 
```
...
**3.2.2) Initiating training.py file**
...
**3.2.3) Pre-processing images and captions dataset** 
...
**3.2.4) Seperating training captions and names of training images** 
...
**3.2.5) Scripting function called "data_generator"**
...
**3.2.6) Creating structure of training model and setting arguments of "compile" method** 
...
**3.2.7) Starting the training process** 
...
**3.2.8) Evaluating the trained model**
